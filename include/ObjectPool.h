...
public:
	...
	T* Alloc()
	{
		CMutexLockGuard<LOCKT>	lock(m_Lock);
...
public:
	...
	size_t GetActiveNum()
	{
		CMutexLockGuard<MAP_LOCK> lock(m_ActiveObjLock);
	...
	TVAL* GetFreeObj()
	{
		CMutexLockGuard<MAP_LOCK> lock(m_FreeObjLock);
...
public:
	...
	size_t GetActiveNum()
	{
		CMutexLockGuard<LIST_LOCK> lock(m_ActiveObjLock);
	...
	T* GetFreeObj()
	{
		CMutexLockGuard<LIST_LOCK> lock(m_FreeObjLock);
